...
/**
 * Logic/Formatter transfered from Stockadapter & Sunshine App
 */
        ...
        return new RemoteViewsFactory() {
            ...
            public RemoteViews getViewAt(int position) {
                ...
                if (PrefUtils.getDisplayMode(getApplicationContext())
                        .equals(getApplicationContext().getString(
                ...
                fillInIntent.putExtra(StockDetailActivity.KEY_SYMBOL, symbol);
            ...
            public void onDataSetChanged() {
                ...
                data = getContentResolver().query(Contract.Quote.uri, Contract.Quote.QUOTE_COLUMNS, null,
